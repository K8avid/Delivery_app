...
import 'add_trip_end_address_page.dart';

class AddTripStartPreviewPage extends StatefulWidget {
  final String address;
  final Map<String, double>? location;

  const AddTripStartPreviewPage({super.key, required this.address, this.location});

  @override
  _AddTripStartPreviewPageState createState() =>
      _AddTripStartPreviewPageState();
}

class _AddTripStartPreviewPageState extends State<AddTripStartPreviewPage>
  ...
  void initState() {
    ...
    if (widget.location != null) {
      ...
      _currentPosition = const LatLng(48.8566, 2.3522); // Paris par défaut
    }
  ...
  if (_currentPosition != null) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => AddTripEndAddressPage(startLocation: startLocation),
      ),
    );
  }
}
