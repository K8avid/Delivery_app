...
// import 'trip_datails_page_with_existing_parcel.dart';


// class ParcelSearchResultsWithExistingParcel extends StatefulWidget {
//   final Map<String, dynamic> parcelInfo;

//   const ParcelSearchResultsWithExistingParcel({super.key, required this.parcelInfo});

//   @override
//   _ParcelSearchResultsWithExistingParcelState createState() =>
//       _ParcelSearchResultsWithExistingParcelState();
// }

// class _ParcelSearchResultsWithExistingParcelState extends State<ParcelSearchResultsWithExistingParcel> {
...
//     final durationHours = (trip['duration'] / 60).floor();
//     final durationMinutes = trip['duration'] % 60;
...
//           context,
//           MaterialPageRoute(
//             builder: (context) => TripDetailsPageWithExistingParcel(
//               trip: trip,
...
class _ParcelSearchResultsWithExistingParcelState extends State<ParcelSearchResultsWithExistingParcel> {
 ...
 // Ajoutez cette méthode dans votre State :
Future<Map<String, dynamic>> _fetchAccessTimes(Map<String, dynamic> trip) async {
  ...
  // Appeler l'API pour obtenir le temps d'accès pour l'expéditeur (senderAddress -> startLocation)
  ...
  // Appeler l'API pour obtenir le temps d'accès pour le destinataire (recipientAddress -> endLocation)
  ...
  return {
    'sender': results[0],     // Exemple : { "duration": 600, "mode": "walking" }
    'recipient': results[1],
  };
}

// Puis remplacez votre méthode _buildTripCard par celle-ci :
