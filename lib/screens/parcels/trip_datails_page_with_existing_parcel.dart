...
// // import 'package:appli/screens/parcels/delivery_processing_page_with_existing_parcel.dart';
// import 'package:flutter/material.dart';
// import 'package:intl/intl.dart';

// //import 'delivery_processing_page.dart';
// import 'delivery_processing_page_with_existing_parcel.dart';
// import 'preview_page.dart';

// class TripDetailsPageWithExistingParcel extends StatelessWidget {
//   final Map<String, dynamic> trip;
//   final Map<String, dynamic> parcel;
//   //final String parcelNumber;

//   const TripDetailsPageWithExistingParcel({super.key, required this.trip, required this.parcel});
...
//     String parcelNumber = parcel['parcelNumber'];
//     print('========[$parcelNumber]========');
...
//       MaterialPageRoute(
//         builder: (context) =>
//             DeliveryProcessingPageWithExistingParcel(requestPayload: requestPayload),
//       ),
//     );
//   }
// }
...
class TripDetailsPageWithExistingParcel extends StatelessWidget {
  ...
  const TripDetailsPageWithExistingParcel({
    super.key,
    required this.trip,
  ...
  Widget build(BuildContext context) {
    ...
    if (parcel.isEmpty) {
      return Scaffold(
        ...
        body: const Center(
          child: Text("Les détails du colis sont introuvables."),
        ),
      );
    }
  ...
  List<Widget> _buildParcelDetailItems() {
    final details = [
      {"title": "Description", "value": parcel['description'] ?? "Non spécifié", "icon": Icons.description},
      {"title": "Poids", "value": "${parcel['weight'] ?? 0} kg", "icon": Icons.scale},
      {"title": "Dimensions", "value": "${parcel['length'] ?? 0} x ${parcel['width'] ?? 0} x ${parcel['height'] ?? 0} cm", "icon": Icons.straighten},
      {"title": "Adresse Expéditeur", "value": parcel['senderAddress'] ?? "Adresse inconnue", "icon": Icons.person},
      {"title": "Adresse Destinataire", "value": parcel['recipientAddress'] ?? "Adresse inconnue", "icon": Icons.person_outline},
    ];
              ...
              child: RichText(
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                      text: detail['value'],
                      style: TextStyle(fontWeight: FontWeight.normal, fontSize: 14, color: Colors.grey.shade700),
                    ),
                  ],
                ),
              ),
  ...
  void _openPreviewPage(BuildContext context, Map<String, dynamic> location, bool isDeparture) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => PreviewPage(
  ...
  void _handleBooking(BuildContext context) {
    String parcelNumber = parcel['parcelNumber'] ?? "Inconnu";
    final requestPayload = {
      "parcelNumber": parcelNumber,
      "tripNumber": trip['tripNumber'],
    };
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => DeliveryProcessingPageWithExistingParcel(requestPayload: requestPayload),
      ),
    );
  }
}
